...
public class FlyweightDemo {
    public static void main(String[] args) {
        ...
        // Plantamos el nuevo tipo de árbol "Abeto" en dos ubicaciones diferentes
        forest.plantTree(70, 80, "Abeto", "Verde oscuro", "Hojas puntiagudas");
        forest.plantTree(75, 85, "Abeto", "Verde oscuro", "Hojas puntiagudas"); // Reutiliza el TreeType Abeto
